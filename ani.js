...
$( "#but12" ).hover(
  function() {
    $('.picture').prepend('<img class="pic1" src="ani5.jpg">')
  }, function() {
    $( '.picture' ).find( ".pic1" ).last().remove();
  }
);
$( "#but13" ).hover(
  function() {
    $('.picture').prepend('<img class="pic2" src="ani6.jpg">')
  }, function() {
    $( '.picture' ).find( ".pic2" ).last().remove();
  }
);
$( "#but14" ).hover(
  function() {
    $('.picture').prepend('<img class="pic3" src="ani7.jpg">')
  }, function() {
    $( '.picture' ).find( ".pic3" ).last().remove();
  }
);
$( "#but15" ).hover(
  function() {
    $('.picture').prepend('<img class="pic4" src="ani8.jpg">')
  }, function() {
    $( '.picture' ).find( ".pic4" ).last().remove();
  }
);
$( "#but16" ).hover(
  function() {
    $('.picture').prepend('<img class="pic2" src="ani9.jpg">')
  }, function() {
    $( '.picture' ).find( ".pic2" ).last().remove();
  }
);
...
$( "#but22" ).hover(
  function() {
    $('.picture').prepend('<img class="pic1" src="gn1.jpg">')
  }, function() {
    $( '.picture' ).find( ".pic1" ).last().remove();
  }
);
